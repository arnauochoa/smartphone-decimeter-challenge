...
campaignName = '2020-08-06-US-MTV-2'; % '2021-04-26-US-SVL-1'; % '2021-04-29-US-MTV-1'; %
% Phone name
phoneName = {'Mi8'}; % {'Mi8', 'Pixel5'}; %{'Pixel4', 'Pixel5', 'SamsungS20Ultra'}; %
% Dataset type
datasetType = 'train';
...
constellations = 'GEC';
% prns = [1 2 3];
obsLabels = {'C1+L1+D1', 'C1+L1+D1', 'C2+L2+D2'};
